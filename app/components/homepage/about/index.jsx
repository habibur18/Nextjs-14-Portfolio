    ...
    <div id="about" className="my-12 lg:my-16 relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
        ...
        <div className="flex justify-center order-1 lg:order-2">
          <Image src={personalData.profile} width={280} height={280} alt="Habibur Rahman - Front-end Developer | Portfolio" className="rounded-lg transition-all duration-1000 grayscale hover:grayscale-0 hover:scale-110 cursor-pointer" />
        </div>
      </div>
    </div>
  );
